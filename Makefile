hterm: main.c nunifont.c nunifont.h *.c *.h
	gcc -g -std=gnu99 main.c base64.c inlinedata.c regis.c nunifont.c nsdl.c ngui.c ssh.c local.c -o hterm -I./libvterm/include -L./libvterm/.libs -L./libssh2/src/.libs -lpng -lssh2 -lvterm -lSDL -lutil -I./libssh2/include  
