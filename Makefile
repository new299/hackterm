hterm: main.c nunifont.c nunifont.h *.c *.h
	gcc -g -std=gnu99 main.c inlinedata.c regis.c nunifont.c nsdl.c ssh.c local.c -o hterm -I./libvterm/include -L./libvterm/.libs -L./libssh2/src/.libs -lpng -lssh2 -lvterm -lSDL -lutil -I./libssh2/include  
